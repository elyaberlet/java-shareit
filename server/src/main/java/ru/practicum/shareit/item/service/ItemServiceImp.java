...
public class ItemServiceImp implements ItemService {
    ...
    public ItemResponseDto create(Long ownerId, ItemCreateDto createDto) {
        ...
        if (createDto.getRequestId() != null) {
            request = requestRepository.findById(createDto.getRequestId())
                    .orElseThrow(() -> new NotFoundException("Request not found with id: " + createDto.getRequestId()));
        }

        Item item = itemMapper.toEntity(createDto, ownerId, request);
        item.setOwner(owner);
